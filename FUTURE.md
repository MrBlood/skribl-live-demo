...
— 858 assertions in the recorded run, a further ~430 across the browser suites,
and a PostgreSQL concurrency suite that runs four gunicorn workers and proves the
