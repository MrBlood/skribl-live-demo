> **HISTORICAL — this is the v98–v136 planning record, not instructions.**
> It describes work as it was being planned and done, in checkbox form, and
> parts of it were already stale when written (see its own opening note). It is
> kept for provenance: it explains WHY the package is shaped as it is.
>
> **To integrate Skribl, read `docs/INTEGRATION.md`.** That file is now a
> working guide with a copy-pasteable example, and every claim in it is
> exercised by `harness/verify_integration.py`.
