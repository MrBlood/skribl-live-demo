# START HERE — Skribl v205 session primer
...
Verify before believing anything in prose, including this file:
    ...
    cd skribl-v205 && sha256sum -c SHA256SUMS | grep -c ': OK'    # expect 173
...
**Upload the current sealed zip (`skribl-v205-sealed.zip`) alongside this file.**
Unzip it; it produces a folder `skribl-v205/`. `git init` goes INSIDE that
...
<!-- HARNESS-COUNTS -->
**PASS WITH SKIPS — 2224 assertions across 59 suites, none failing, 1 skipped** on sqlite as of v205 (tree `aa3159a59658`).
