...
Verify before believing anything in prose, including this file:
    ...
    cd skribl-v202 && sha256sum -c SHA256SUMS | grep -c ': OK'    # expect 168
...
<!-- HARNESS-COUNTS -->
**PASS WITH SKIPS — 2165 assertions across 59 suites, none failing, 1 skipped** on sqlite as of v202 (tree `67e8e53f37da`).
