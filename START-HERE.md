# START HERE — Skribl v214 session primer
...
Verify before believing anything in prose, including this file:
    ...
    cd skribl-v214 && sha256sum -c SHA256SUMS | grep -c ': OK'    # expect 196
...
<!-- HARNESS-COUNTS -->
**PASS WITH SKIPS — 2561 assertions across 60 suites, none failing, 2 skipped** on sqlite as of v214 (tree `041bc7b1f37c`).
...
Four tools plus five controls does not fit a 375px phone. The magnify button is
hidden below 400px — pinch already zooms — but **hiding it was not safe as
