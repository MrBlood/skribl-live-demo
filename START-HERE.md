# START HERE — Skribl v206 session primer
...
Verify before believing anything in prose, including this file:
    ...
    cd skribl-v206 && sha256sum -c SHA256SUMS | grep -c ': OK'    # expect 174
...
**Upload the current sealed zip (`skribl-v206-sealed.zip`) alongside this file.**
Unzip it; it produces a folder `skribl-v206/`. `git init` goes INSIDE that
...
<!-- HARNESS-COUNTS -->
**PASS WITH SKIPS — 2244 assertions across 59 suites, none failing, 1 skipped** on sqlite as of v206 (tree `8917684ded04`).
