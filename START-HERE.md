# START HERE — Skribl v192 session primer
...
Verify before believing anything in prose, including this file:
    ...
    cd skribl-v192 && sha256sum -c SHA256SUMS | grep -c ': OK'    # expect 139
...
**Upload `skribl-v192.zip` alongside this file.** Unzip it; it produces a folder
`skribl-v192/`. `git init` goes INSIDE that folder, not above it.
...
<!-- HARNESS-COUNTS -->
**PASS WITH SKIPS — 1741 assertions across 43 suites, none failing, 2 skipped** on sqlite as of v192 (tree `1ea03adcf3f7`).
