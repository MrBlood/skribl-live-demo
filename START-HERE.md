# START HERE — Skribl v193 session primer
...
Verify before believing anything in prose, including this file:
    ...
    cd skribl-v193 && sha256sum -c SHA256SUMS | grep -c ': OK'    # expect 140
...
**Upload `skribl-v193.zip` alongside this file.** Unzip it; it produces a folder
`skribl-v193/`. `git init` goes INSIDE that folder, not above it.
...
<!-- HARNESS-COUNTS -->
**PASS WITH SKIPS — 1817 assertions across 44 suites, none failing, 2 skipped** on sqlite as of v193 (tree `70cf761b7f84`).
