...
Verify before believing anything in prose, including this file:
    ...
    cd skribl-v191 && sha256sum -c SHA256SUMS | grep -c ': OK'    # expect 139
...
<!-- HARNESS-COUNTS -->
**PASS WITH SKIPS — 1739 assertions across 43 suites, none failing, 2 skipped** on sqlite as of v191 (tree `59499fe1977c`).
