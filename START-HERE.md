# START HERE — Skribl v198 session primer
...
Verify before believing anything in prose, including this file:
    ...
    cd skribl-v198 && sha256sum -c SHA256SUMS | grep -c ': OK'    # expect 142
...
**Upload `skribl-v198.zip` alongside this file.** Unzip it; it produces a folder
`skribl-v198/`. `git init` goes INSIDE that folder, not above it.
...
<!-- HARNESS-COUNTS -->
**PASS WITH SKIPS — 1850 assertions across 45 suites, none failing, 2 skipped** on sqlite as of v198 (tree `397d93bf21f7`).
