# START HERE — Skribl v207 session primer
...
Verify before believing anything in prose, including this file:
    ...
    cd skribl-v207 && sha256sum -c SHA256SUMS | grep -c ': OK'    # expect 177
...
**Upload the current sealed zip (`skribl-v207-sealed.zip`) alongside this file.**
Unzip it; it produces a folder `skribl-v207/`. `git init` goes INSIDE that
...
<!-- HARNESS-COUNTS -->
**PASS WITH SKIPS — 2310 assertions across 59 suites, none failing, 1 skipped** on sqlite as of v207 (tree `ac316597ac0e`).
