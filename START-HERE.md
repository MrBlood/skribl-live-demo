# START HERE — Skribl v211 session primer
...
Verify before believing anything in prose, including this file:
    ...
    cd skribl-v211 && sha256sum -c SHA256SUMS | grep -c ': OK'    # expect 185
...
**Upload the current sealed zip (`skribl-v211-sealed.zip`) alongside this file.**
Unzip it; it produces a folder `skribl-v211/`. `git init` goes INSIDE that
...
<!-- HARNESS-COUNTS -->
**PASS WITH SKIPS — 2416 assertions across 60 suites, none failing, 1 skipped** on sqlite as of v211 (tree `d7090f8352af`).
