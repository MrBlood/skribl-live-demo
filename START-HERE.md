# START HERE — Skribl v210 session primer
...
Verify before believing anything in prose, including this file:
    ...
    cd skribl-v210 && sha256sum -c SHA256SUMS | grep -c ': OK'    # expect 183
...
**Upload the current sealed zip (`skribl-v210-sealed.zip`) alongside this file.**
Unzip it; it produces a folder `skribl-v210/`. `git init` goes INSIDE that
...
<!-- HARNESS-COUNTS -->
**PASS WITH SKIPS — 2374 assertions across 60 suites, none failing, 1 skipped** on sqlite as of v210 (tree `87e3fa86b7cc`).
