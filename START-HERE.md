...
<!-- HARNESS-COUNTS -->
**PASS WITH SKIPS — 5245 assertions across 98 reporting suites (100 on disk, 2 skipped), none failing** on sqlite as of v300 (tree `6990f1447731`).
...
| `pointbudget.js` | Flip | The DOCUMENT's point budget — the one number the editors were spending without being able to see it. |
