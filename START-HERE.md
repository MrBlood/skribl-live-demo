...
Verify before believing anything in prose, including this file:
    ...
    cd skribl-v199 && sha256sum -c SHA256SUMS | grep -c ': OK'    # expect 156
...
<!-- HARNESS-COUNTS -->
**PASS WITH SKIPS — 2137 assertions across 59 suites, none failing, 1 skipped** on sqlite as of v200 (tree `e1d97f18a2f4`).
