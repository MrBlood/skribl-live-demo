...
Verify before believing anything in prose, including this file:
    ...
    cd skribl-v199 && sha256sum -c SHA256SUMS | grep -c ': OK'    # expect 155
...
<!-- HARNESS-COUNTS -->
**PASS WITH SKIPS — 1972 assertions across 52 suites, none failing, 2 skipped** on sqlite as of v199 (tree `b2703c4e8b46`).
