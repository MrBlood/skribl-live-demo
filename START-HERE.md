# START HERE — Skribl v209 session primer
...
Verify before believing anything in prose, including this file:
    ...
    cd skribl-v209 && sha256sum -c SHA256SUMS | grep -c ': OK'    # expect 181
...
**Upload the current sealed zip (`skribl-v209-sealed.zip`) alongside this file.**
Unzip it; it produces a folder `skribl-v209/`. `git init` goes INSIDE that
...
<!-- HARNESS-COUNTS -->
**PASS WITH SKIPS — 2337 assertions across 59 suites, none failing, 1 skipped** on sqlite as of v209 (tree `4bc69bc4b582`).
