...
Current version: **v285** (`SKRIBL_VERSION` in `skribl/core.py`; the archive filename is derived from it)
...
<!-- HARNESS-COUNTS -->
**PASS WITH SKIPS — 4609 assertions across 97 reporting suites (99 on disk, 2 skipped), none failing** on sqlite as of v285 (tree `e0b95ab24909`).
