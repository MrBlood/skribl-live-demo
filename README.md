...
Current version: **v289** (`SKRIBL_VERSION` in `skribl/core.py`; the archive filename is derived from it)
...
<!-- HARNESS-COUNTS -->
**PASS WITH SKIPS — 4702 assertions across 97 reporting suites (99 on disk, 2 skipped), none failing** on sqlite as of v288 (tree `6212156345bf`).
