...
Current version: **v300** (`SKRIBL_VERSION` in `skribl/core.py`; the archive filename is derived from it)
...
<!-- HARNESS-COUNTS -->
**PASS WITH SKIPS — 5234 assertions across 98 reporting suites (100 on disk, 2 skipped), none failing** on sqlite as of v299 (tree `4c423808ca0f`).
