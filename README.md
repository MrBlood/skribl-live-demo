...
Current version: **v267** (`SKRIBL_VERSION` in `skribl/core.py`; the archive filename is derived from it)
...
<!-- HARNESS-COUNTS -->
**RUN NOT GREEN — 1 suite(s) failed:** verify_docs.py. 3849 assertions passed across 85 suite(s) that did report, on sqlite as of v267 (tree `a63c55414596`).
