...
Current version: **v299** (`SKRIBL_VERSION` in `skribl/core.py`; the archive filename is derived from it)
...
<!-- HARNESS-COUNTS -->
**PASS WITH SKIPS — 5165 assertions across 98 reporting suites (100 on disk, 2 skipped), none failing** on sqlite as of v298 (tree `05233e8d70eb`).
