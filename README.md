...
Current version: **v294** (`SKRIBL_VERSION` in `skribl/core.py`; the archive filename is derived from it)
...
<!-- HARNESS-COUNTS -->
**RUN NOT GREEN — 1 suite(s) failed:** verify_inbetween.py. 0 assertions passed across 0 suite(s) that did report, on sqlite as of v294 (tree `786cc7b8a455`).
