...
Current version: **v291** (`SKRIBL_VERSION` in `skribl/core.py`; the archive filename is derived from it)
...
<!-- HARNESS-COUNTS -->
**PASS WITH SKIPS — 4764 assertions across 97 reporting suites (99 on disk, 2 skipped), none failing** on sqlite as of v290 (tree `74c313f42d14`).
