...
Current version: **v284** (`SKRIBL_VERSION` in `skribl/core.py`; the archive filename is derived from it)
...
<!-- HARNESS-COUNTS -->
**PASS WITH SKIPS — 4598 assertions across 97 reporting suites (99 on disk, 2 skipped), none failing** on sqlite as of v283 (tree `8b479d112258`).
