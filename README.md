...
Current version: **v280** (`SKRIBL_VERSION` in `skribl/core.py`; the archive filename is derived from it)
...
<!-- HARNESS-COUNTS -->
**PASS WITH SKIPS — 4567 assertions across 98 reporting suites (99 on disk, 1 skipped), none failing** on sqlite as of v280 (tree `535513674a09`).
