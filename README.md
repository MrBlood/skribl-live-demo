...
Current version: **v273** (`SKRIBL_VERSION` in `skribl/core.py`; the archive filename is derived from it)
...
<!-- HARNESS-COUNTS -->
**PASS WITH SKIPS — 3995 assertions across 88 reporting suites (89 on disk, 1 skipped), none failing** on sqlite as of v273 (tree `fe42dcc05530`).
