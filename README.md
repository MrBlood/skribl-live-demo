...
Current version: **v287** (`SKRIBL_VERSION` in `skribl/core.py`; the archive filename is derived from it)
...
<!-- HARNESS-COUNTS -->
**RUN NOT GREEN — 1 suite(s) failed:** verify_docs.py. 4559 assertions passed across 96 suite(s) that did report, on sqlite as of v287 (tree `6d96ab19b186`).
